...
const translations = {
  en: {
    ...
    "productSetup.notifyQty": "Notify me when qty drops to",
    "productSetup.notifyQtyPlaceholder": "Enter notification quantity",
  ...
  ar: {
    ...
    "productSetup.notifyQty": "أخطرني عندما تنخفض الكمية إلى",
    "productSetup.notifyQtyPlaceholder": "أدخل كمية التنبيه",
