...
const API_ENDPOINTS = [
  ...
  },
  {
    ...
    method: "POST",
    description: "Create or update Salla e-commerce transactions. Uses upsert logic - if Order_Number exists, data will be updated; otherwise, a new record is created. Data is saved to purpletransaction_temp table.",
    upsertKey: "Order_Number",
    fields: [
      { name: "Order_Number", type: "Text", required: true, note: "Primary Key (Upsert Key)" },
      { name: "Customer_Phone", type: "Text", required: true, note: "Customer phone number" },
      { name: "Customer_Name", type: "Text", required: false, note: "Customer name" },
      { name: "Order_Date", type: "DateTime", required: true, note: "Order date" },
      { name: "Brand_Name", type: "Text", required: false, note: "Brand name" },
      { name: "Brand_Code", type: "Text", required: false, note: "Brand code" },
      { name: "Product_Name", type: "Text", required: false, note: "Product name" },
      { name: "Product_Id", type: "Text", required: false, note: "Product identifier" },
      { name: "Coins_Number", type: "Decimal", required: false, note: "Number of coins" },
      { name: "Unit_Price", type: "Decimal", required: false, note: "Unit price" },
      { name: "Cost_Price", type: "Decimal", required: false, note: "Cost price" },
      { name: "Quantity", type: "Decimal", required: false, note: "Quantity" },
      { name: "Cost_Sold", type: "Decimal", required: false, note: "Total cost sold" },
      { name: "Total", type: "Decimal", required: false, note: "Total amount" },
      { name: "Profit", type: "Decimal", required: false, note: "Profit amount" },
      { name: "Payment_Method", type: "Text", required: false, note: "Payment method" },
      { name: "Payment_Type", type: "Text", required: false, note: "Payment type" },
      { name: "Payment_Brand", type: "Text", required: false, note: "Payment brand" },
      { name: "Company", type: "Text", required: true, note: "Company name" },
      { name: "Status", type: "Int", required: false, note: "Order status code" },
      { name: "Status_Description", type: "Text", required: false, note: "Status description" },
      { name: "Sales_Person", type: "Text", required: false, note: "Sales person name" },
      { name: "Transaction_Type", type: "Text", required: false, note: "automatic/Manual" },
      { name: "Media", type: "Text", required: false, note: "Marketing media source" },
      { name: "Profit_Center", type: "Text", required: false, note: "Salla/WebApp/MobApp" },
      { name: "Customer_IP", type: "Text", required: false, note: "Customer IP address" },
      { name: "Device_Fingerprint", type: "Text", required: false, note: "Device info" },
      { name: "Transaction_Location", type: "Text", required: false, note: "KSA, CAIRO etc" },
      { name: "Payment_Term", type: "Text", required: false, note: "immediate/15/30/60" },
      { name: "Player_Id", type: "Text", required: false, note: "Player identifier" },
      { name: "Point_Value", type: "Decimal", required: false, note: "Point value" },
      { name: "Point", type: "Bit", required: false, note: "Point flag (0=No, 1=Yes)" },
      { name: "Vendor_Name", type: "Text", required: false, note: "Vendor name" },
      { name: "Order_Status", type: "Text", required: false, note: "Order status text" },
    ],
  },
  {
    id: "lookup",
