...
import { Plus, Trash2, Save, FileText, Receipt, ArrowLeft, Printer, Upload } from "lucide-react";
        ...
        <CardHeader className="flex flex-row items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <CardTitle className="flex items-center gap-2">
              ...
              {id ? (language === "ar" ? "تعديل قيد المصروفات" : "Edit Expense Entry") : (language === "ar" ? "قيد مصروفات جديد" : "New Expense Entry")}
            </CardTitle>
          </div>
