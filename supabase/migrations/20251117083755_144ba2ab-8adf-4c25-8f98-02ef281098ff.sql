CREATE OR REPLACE FUNCTION public.update_ordertotals_bank_fees_by_brand(brand_name text, batch_size integer DEFAULT 5000)
RETURNS integer
LANGUAGE plpgsql
SECURITY DEFINER
...
BEGIN
  LOOP
    ...
    EXIT WHEN last_id IS NULL; -- no more rows in this brand
  END LOOP;
