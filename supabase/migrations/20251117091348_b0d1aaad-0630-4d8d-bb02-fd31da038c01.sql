-- Fix CTE scoping by separating batch selection from update logic
...
BEGIN
  LOOP
    -- First, get the batch of IDs to process
    SELECT array_agg(o.id ORDER BY o.id) INTO batch_ids
    ...
    -- Now update the batch using the IDs
